...
// Bi-directional A* Search (Based on BOBA*) using Heuristic Tuning with Last expanded path (HTL)
...
{
public:
    WC_BA_HTL(graph *G, graph *G_rev, experiment exp)
    {
...
//////////////////////////////////////////////////////
private:
    cost_t *h1_f, *ub1_f, *h2_f, *ub2_f, *g_min_f, *g_max_f, *f_val_1_f, *f_val_2_f;
    cost_t *h1_b, *ub1_b, *h2_b, *ub2_b, *g_min_b, *g_max_b, *f_val_1_b, *f_val_2_b;
...
//////////////////////////////////////////////////////
    ...
    initialise_parameters(sn_id_t num_vertices)
    {
        ...
        g_max_f = new cost_t[num_vertices](); g_max_b = new cost_t[num_vertices]();
...
//////////////////////////////////////////////////////
    void *Main_search_f1f2(
        ...
        , cost_t *g_max_pri, cost_t *g_max_pri_op
        , sn_id_t source
        , Parent_list *&Paths
        ...
        *current_label = LABEL(h_pri[source], 0, source, EDGE_CAP_MAX, PATH_ARR_SIZE_MAX);
        ...
        while (open_.size())
        {
            ...
            else
            {
                ...
                // Heuristic Tuning using the last expanded path of the opposite direction
                g_max_pri[current_vertex] = current_label_g_pri;
                if(g_min_sec_op[current_vertex] != COST_MAX && current_label_g_pri + g_min_sec_op[current_vertex] > primary_ub)
                {    
                    h_sec[current_vertex] = g_max_pri_op[current_vertex];
